...
Digitale Assistenzsysteme haben sich längst im beruflichen Alltag etabliert. Mit dem Aufkommen von immer leistungsstärkeren KI-Modellen werden immer mehr datenverarbeitende Prozesse durch neue KI basierte Methodiken erweitert oder ersetzt. Effizienz, Automatisierbarkeit und Intelligenz werden oft als Mehrwert gepriesen und KI somit gerechtfertigt. Dazu wird dieser Trend durch die aktuelle wirtschaftliche Dynamik erheblich getrieben. KI wird als zentrale Komponente von zukünftiger Innovation und Wertschöpfung positioniert \cite{GlobalAIAdoption2025}. Dennoch wächst auch die gesellschaftliche Kritik am unreflektierten Einsatz von und Umgang mit diesen Technologien. Speziell der hohe Energieverbrauch der mit KI-Modellen verbundenen Infrastruktur stehen in der Kritik \cite{jiSystematicReviewElectricity2026a,EnergyAI2025}. Dabei stehen ökologische und soziale Implikationen im Vordergrund, vor allem der Einsatz von KI Modellen für Problemstellungen für die wesentlich effizientere Alternativen existieren \cite{akohatadogaToolsTechniquesTrends2024,ventersSustainableSoftwareEngineering2023}. Es stellt sich die Frage, ob der Einsatz von KI immer wirklich die sinnvollste technische und ethische Lösung darstellt. 
