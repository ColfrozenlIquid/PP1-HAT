...
Der Trainingsprozess dieser Modelle stellt initial den größten Energieverbrauch dar. In der Literatur wird das Trainieren von OpenAI's GPT-4 auf über 50 Gigawattstunden geschätzt, das 40-fache des Vorgängermodels GPT-3 \cite{jiSystematicReviewElectricity2026a}. Jedoch macht der Produktivbetrieb der Modelle im Inferenzprozess den Großteil des Ressourcenverbrauchs aus. Laut aktuellen Schätzwerten liegt der Energieverbrauch pro Text Anfrage zwischen 0.24 und 0.34 Wattstunden \cite{elsworthMeasuringEnvironmentalImpact2025}. Bei über 2,5 Milliarden täglichen Anfragen an Chat-GPT akkumulieren 850 Megawattstunden \cite{chatterjiHowPeopleUsea}.
