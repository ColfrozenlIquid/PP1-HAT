...
Der Trainingsprozess dieser Modelle stellt initial den größten Energieverbrauch dar. In der Literatur wird das Trainieren von OpenAI's GPT-4 auf über 50 Gigawattstunden geschätzt, das 40-fache des Vorgängermodels GPT-3 \cite{jiSystematicReviewElectricity2026a}. Jedoch macht der Produktivbetrieb der Modelle im Inferenzprozess den Großteil des Ressourcenverbrauchs aus. Laut aktuellen Schätzwerten liegt der Energieverbrauch pro \textit{kurzer} (400 Tokens) Text Anfrage an GPT-4 bei 1.82 Wattstunden \cite{elsworthMeasuringEnvironmentalImpact2025,jeghamHowHungryAI2025}. Bei über 2,5 Milliarden täglichen Anfragen an Chat-GPT akkumulieren 4,55 Gigawattstunden \cite{chatterjiHowPeopleUsea}.
