...
\begin{description}[noitemsep,topsep=5pt]
    ...
    \item \textbf{3. Transparenz}: LLMs sind nur schwer nachvollziehbar. Weder der Benutzer noch der Entwickler können erklären, warum das Modell bestimmte Antworten liefert. Somit wird auch Kontrollierbarkeit und Validierung erschwert, was zu Unregelmäßigkeiten und Problemen in der Benutzung führen kann. Praktische Interaktion mit dem System hat gezeigt, dass die nicht-deterministische Natur des LLMs zu irreführenden Ergebnissen und unberechenbaren Rückgaben und Zuständen geführt hat, die in einem deterministischen System deutlich seltener vorkommen könnten. Alternative Systeme wären vollständig erklärbar, und für diesen Anwendungskontext deutlich besser geeignet. Transparenz ist kaum gegeben.
    \item \textbf{4. Nachhaltigkeit}: Die ökologische Belastung durch den Einsatz von LLM-APIs ist im Vergleich zu regelbasierten Verfahren ungleich höher. Das wiederholte Durchlaufen einer Interferenz mit derselben Anfrage spricht vollkommen gegen die Nachhaltigkeit. Zudem ist auch soziale Nachhaltigkeit durch Abhängigkeiten von Anbietersystemen und Kompetenzverlust im Unternehmen geschwächt. Die ökologischen Bedenken überwiegen hier klar den eigentlichen Nutzen, was gegen die Nachhaltigkeit spricht.
    \item \textbf{5. Verhältnismäßigkeit}: Die Verwendung des KI-basierten Assistenten aufgrund von Komfort und Benutzerfreundlichkeit wirft Fragen in seiner Verhältnismäßigkeit auf. Einerseits bietet der Einsatz des LLM enorme Vorteile in der Generierung von und Extrahierung aus natürlichem Text. Dazu kann das LLM besser auf Benutzerwünsche und Bedürfnisse eingehen. Dennoch steht der Gebrauch von einem LLM für das Extrahieren von validierbaren Schlüsselwörtern aus Text in keinem Verhältnis zu den ökologischen Kosten. Für den gegebenen Zweck lässt sich ein vergleichbarer Nutzen mit weniger Aufwand erzielen. 
    ...
    \item \textbf{7. Werteorientierung}: Der Einsatz von KI unterstützt zwar das Ziel der Barrierefreiheit, steht jedoch zugleich im Widerspruch zu ökologischer Nachhaltigkeit und Transparenz als zentrale Stakeholderwerte. Die Werteorientierung fällt damit ambivalent aus.
\end{description}
