...
\begin{lstlisting}[language=Rust, frame=single, caption={Thread safety using Sync and Send traits. Locking the mutex is enforced at compile time.}, captionpos=b]
