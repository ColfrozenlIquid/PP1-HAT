...
\documentclass[
    ...
    footinclude=false,cleardoublepage=empty,abstract=false,
    BCOR=5mm,paper=a4,fontsize=11pt,twocolumn
...
\include{chapters/TechnischerHintergrund}
\include{chapters/EthischePerspektiven}
